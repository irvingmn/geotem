...
<!--[if gt IE 9]><!-->	<html lang="es"> <!--<![endif]-->
	...
	<head>
		...
		<title>Geotem - Gravimetría</title>
						...
						<div id="rev_slider_18_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
							...
							<ul>
								...
								<li data-index="rs-59" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="assets/images/demo/rs5/newspaper_bg1-100x50.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="Construcción" data-description="">
									...
									<img src="img/banner/bmetodos/GRV.png"wid  alt=""  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										style="z-index: 6; zoom:0.47; zoom:0.7"><a href="#"><img class="footer-logo" src="img/iconos/icongeotermia.png"  width="100" height="auto"alt="" /></a>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										data-x="['left','left','left','left']" data-hoffset="['1780','1700','1660','1540']" 

										data-y="['top','top','top','top']" data-voffset="['460','440','-40','-40']" 
										...
										style="z-index: 6; zoom:0.4;"><a href="#"><img class="footer-logo" src="img/iconos/iconegro.png"  width="100" height="auto"alt="" /></a>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div style="margin-bottom: 30px;"class="heading-title heading-dotted text-center">
							...
							<img class="img-responsive" src="img/metodos/potencial1/titulo10.png" alt="">
						...
						<div class="col-sm-6">
							...
							<p class=" justify weight-400 letter-spacing-1 size-25">El método gravimétrico fue la primera técnica geofísica utilizada para la exploración de hidrocarburos. Consiste en la medición de las pequeñas variaciones en el campo de gravedad terrestre, como consecuencia de las distribuciones de masa presentes en el subsuelo (deficiencias y/o excesos de densidad). <br> <br>Las variaciones son tan pequeñas que es necesario el uso de instrumentos de registro de alta precisión capaces de mapear las variaciones del campo, punto a punto sobre la superficie terrestre llamados gravímetros. </p>

							<hr style="margin-bottom: -20px;"/>

							<div align="center"><img align="center" src="img/iconos/potenciales.png" alt="potencial1"></div>
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/potencial1/ProcesoE2.png">

									<img src="img/metodos/potencial1/ProcesoE2.png" alt="...">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/potencial1/GRV_1.JPG" >

									<img src="img/metodos/potencial1/GRV_1.JPG" alt="...">

								</a>

								<a class="image-hover" href="img/metodos/potencial1/GRV_Chile.JPG" >

									<img src="img/metodos/potencial1/GRV_Chile.JPG" alt="...">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/potencial1/C.png">

									<img src="img/metodos/potencial1/C.png" alt="...">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/potencial1/B.jpg" >

									<img src="img/metodos/potencial1/B.jpg" alt="...">
						...
						<div class="col-sm-6">
							...
							<p class=" justify weight-400 letter-spacing-1 size-28">La prospección gravimétrica es el método por el cual se analizan los cambios del campo gravitacional generados por los diferentes materiales de la Tierra, que al ser comparadas con la gravedad normal y después de aplicar las correcciones necesarias (mareas, deriva del instrumento, latitud, altura), dan lugar a anomalías gravimétricas. La unidad fundamental en el sistema CGS es el Gal. <br>Una correcta interpretación de las anomalías puede servir para detectar variaciones verticales y laterales de la densidad de las rocas, que puedan definir el comportamiento del subsuelo. </p>
