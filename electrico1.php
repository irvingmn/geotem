...
<!--[if gt IE 9]><!-->	<html lang="es"> <!--<![endif]-->
	<head>
		<meta charset="utf-8" />
		<title>Geotem - Sondeo Eléctrico Vertical</title>
		...
		<div id="wrapper">
						...
						<div id="rev_slider_18_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
							<ul>
								...
								<li data-index="rs-59" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="assets/images/demo/rs5/newspaper_bg1-100x50.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="Construcción" data-description="">
									<!-- MAIN IMAGE -->
									<img src="img/banner/bmetodos/SEV_1.jpg"wid  alt=""  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										style="z-index: 6; zoom:0.7;"><a href="geohidro.php"><img class="footer-logo" src="img/iconos/icongeohidrologia.png"  width="50" height="auto"alt="geotermia" /></a>
									</div>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										style="z-index: 6; zoom:0.47; zoom:0.7"><a href="#"><img class="footer-logo" src="img/iconos/icongeotecnia.png"  width="100" height="auto"alt="" /></a>
									</div>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										style="z-index: 6; zoom:0.7;"><a href="#"><img class="footer-logo" src="img/iconos/icoambiental.png"  width="100" height="auto"alt="" /></a>
									</div>

									<!-- LAYER NR. ENTRENA -->
									<div class="tp-caption   rs-parallaxlevel-0" 
										id="slide-20-layer-2" 
										data-x="['left','left','left','left']" data-hoffset="['1630','1700','1660','1540']" 
										data-y="['top','top','top','top']" data-voffset="['440','440','-40','-40']" 
										data-width="none"
										data-height="none"
										data-whitespace="nowrap"
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										id="slide-20-layer-2" 
										data-x="['left','left','left','left']" data-hoffset="['1740','1700','1660','1540']" 
										data-y="['top','top','top','top']" data-voffset="['440','440','-40','-40']" 
										data-width="none"
										data-height="none"
										data-whitespace="nowrap"
				...
				<div class="container">
					...
					<div class="row">
						<div style="margin-bottom: 30px;"class="heading-title heading-dotted text-center">
							<img class="img-responsive" src="img/metodos/electrico3/titulo9.png" alt="">
						</div>

						<div class="col-sm-6">
							<p class=" justify weight-400 letter-spacing-1 size-25">El método consiste en determinar el parámetro de resistividad a profundidad, mediante la inyección de corriente eléctrica en el subsuelo y la medición del potencial resultante a través de un arreglo electródico tetraelectródico. <br> El Sondeo Eléctrico Vertical (SEV) como método geofísico de corriente directa (DC) es muy utilizado por su sencillez y la relativa economía instrumental apropiado para la adquisición en campo. </p>
							<hr style="margin-bottom: -20px;"/>
							<div align="center"><img align="center" src="img/iconos/electrico.png" alt="electro1"></div>
							
							<p class=" text-center weight-400 letter-spacing-1 size-30">Profundidad: 5m a 1 km*<br>Fuente: Controlada <br>Modalidad Terrestre</p>
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electrico3/QR S5-2.jpg">
									<img src="img/metodos/electrico3/QR S5-2.jpg" alt="...">
								</a> <br>

							</div>
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>

								<a class="image-hover" href="img/metodos/electrico3/PrincipioFisico.png" >
									<img src="img/metodos/electrico3/PrincipioFisico.png" alt="...">
								</a>
							</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electrico3/SEV-Procesamiento.jpg">
									<img src="img/metodos/electrico3/SEV-Procesamiento.jpg" alt="...">
								</a> <br>

							</div>
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="4" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>

								<a class="image-hover" href="img/metodos/electrico3/1.png" >
									<img src="img/metodos/electrico3/1.png" alt="...">
								</a>
							</div>
						...
						<div class="col-sm-6">
							<p class=" justify weight-400 letter-spacing-1 size-28">Para la aplicación del método en campo, se distribuyen los electrodos con un orden definido, denominado dispositivo electródico.  En la técnica Schlumberger, el arreglo consiste en cuatro electrodos alineados y simétricos respecto al centro de sondeo, utilizando la separación entre los electrodos de potencial, que es pequeña en relación con los electrodos de corriente (AB/5>MN>AB/20). </p>
							<hr />							
						</div>
			...
			<section style="padding-top: 20px;">
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-6">
							<p class=" justify weight-400 letter-spacing-1 size-25"> Para conocer los valores de resistividad a mayores  profundidades, se incrementa de forma escalonada  la separación de los electrodos de corriente y de potencial, para que la corriente eléctrica atraviese los estratos del subsuelo cada vez a mayor profundidad.  Los equipos funcionan con baterías o con motogenerador, lo que permite investigar acuíferos someros a poca profundidad o relacionar la composición geológica del suelo con fines de caracterización.  </p>
							<hr style="margin-bottom: -20px;"/>
						</div>
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-3 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electrico3/Adquisi.JPG">
									<img src="img/metodos/electrico3/Adquisi.JPG" alt="...">
								</a>
								<a class="image-hover" href="img/metodos/electrico3/SEV-Perfil.png">
									<img src="img/metodos/electrico3/SEV-Perfil.png" alt="...">
								</a>
								<a class="image-hover" href="img/metodos/electrico3/SEV-modelo3D.png">
									<img src="img/metodos/electrico3/SEV-modelo3D.png" alt="...">
								</a>
							</div>
