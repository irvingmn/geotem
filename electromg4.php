...
<!--[if gt IE 9]><!-->	<html lang="es"> <!--<![endif]-->
	<head>
		<meta charset="utf-8" />
		<title>Geotem - Transistorio Electromagnético en el Dominio del Tiempo</title>
						...
						<div id="rev_slider_18_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
							<ul>
								...
								<li data-index="rs-59" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="assets/images/demo/rs5/newspaper_bg1-100x50.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="Construcción" data-description="">
									<!-- MAIN IMAGE -->
									<img src="img/banner/bmetodos/transist.jpg"wid  alt=""  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										style="z-index: 6; zoom:0.47;"><a href=""><img class="footer-logo" src="img/iconos/iconegro.png"  width="100" height="auto"alt="" /></a>
									</div>
								</li>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electromg1/A.png">
									<img src="img/metodos/electromg1/A.png" alt="...">
								</a> <br>

							</div>
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>

								<a class="image-hover" href="img/metodos/electromg1/tedt.jpg" >
									<img src="img/metodos/electromg1/tedt.jpg" alt="...">
								</a>
							</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electromg1/C.png">
									<img src="img/metodos/electromg1/C.png" alt="...">
								</a> <br>

							</div>
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>

								<a class="image-hover" href="img/metodos/electromg1/B.png" >
									<img src="img/metodos/electromg1/B.png" alt="...">
								</a>
							</div>
						...
						<div class="col-sm-6">
							<p class=" justify weight-400 letter-spacing-1 size-28">Un receptor en superficie mide las variaciones del campo magnético secundario  la cual es registrada como un decaimiento de voltaje con el tiempo, esto contiene la información sobre la distribución de resistividad eléctrica en el subsuelo, ya que depende de la magnitud y distribución de la corriente inducida. En este método la fuente consiste en una bobina de forma rectangular que puede ser dispuesta sobre el terreno en una variedad de arreglos; los cuales están clasificados en función de los objetivos geológicos de interés así como de las condiciones del terreno. </p>
							<hr />							
						</div>
