...
<!--[if gt IE 9]><!-->	<html lang="es"> <!--<![endif]-->
	...
	<head>
		...
		<title>Polarización Inducida en el Dominio del Tiempo (IP)</title>
						...
						<div id="rev_slider_18_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
							...
							<ul>
								...
								<li data-index="rs-59" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="assets/images/demo/rs5/newspaper_bg1-100x50.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="Construcción" data-description="">
									...
									<img src="img/banner/bmetodos/Polar.JPG"  alt=""  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										style="z-index: 6; zoom:0.7;"><a href="hidrologia.php"><img class="footer-logo" src="img/iconos/icongeohidrologia.png"  width="50" height="auto" alt="GEOTECNIA" /></a>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										style="z-index: 6; zoom:0.47; zoom:0.7"><a href="geotecnia.php"><img class="footer-logo" src="img/iconos/icongeotecnia.png"  width="100" height="auto" alt="" /></a>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										data-responsive_offset="on" 
										  ...
										  style="z-index: 6; zoom:0.7;"><a href="medio-ambiente.php"><img class="footer-logo" src="img/iconos/icoambiental.png"  width="100" height="auto" alt="" /></a>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div style="margin-bottom: 30px;" class="heading-title heading-dotted text-center">
							...
							<img class="img-responsive" src="img/metodos/electrico5/titulo30.png" alt="">
						...
						<div class="col-sm-6">
							...
							<p class=" text-center weight-400 letter-spacing-1 size-30">Profundidad: 5m a 200m <br>Fuente: Controlada <br>Modalidad Terrestre</p>
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="2" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>

								<a class="image-hover" href="img/metodos/electrico5/Polar5.jpg">

									<img src="img/metodos/electrico5/Polar5.jpg" alt="...">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electrico5/Polar4.jpg" >

									<img src="img/metodos/electrico5/Polar4.jpg" alt="...">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="2" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								<a class="image-hover" href="img/metodos/electrico5/Polar2.png">
								<br><br><br>

									<img src="img/metodos/electrico5/Polar2.png" alt="...">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="2" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electrico5/Polar3.png">

									<img src="img/metodos/electrico5/Polar3.png" alt="...">
