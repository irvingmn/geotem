...
<!--[if gt IE 9]><!-->	<html lang="es"> <!--<![endif]-->
	<head>
		<meta charset="utf-8" />
		<title>Geotem - Tomografía de Resistividad Eléctrica</title>
						...
						<div id="rev_slider_18_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
							<ul>
								...
								<li data-index="rs-59" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="assets/images/demo/rs5/newspaper_bg1-100x50.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="Construcción" data-description="">
									<!-- MAIN IMAGE -->
									<img src="img/banner/bmetodos/TRE.jpg"wid  alt=""  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										style="z-index: 6; zoom:0.7;"><a href="geohidro.php"><img class="footer-logo" src="img/iconos/icongeohidrologia.png"  width="100" height="auto"alt="" /></a>
									</div>
				...
				<div class="container">
					...
					<div class="row">
						<div style="margin-bottom: 30px;"class="heading-title heading-dotted text-center">
							<img class="img-responsive" src="img/metodos/electrico1/titulo8.png" alt="">
						</div>

						<div class="col-sm-6">
							<p class=" justify weight-400 letter-spacing-1 size-25">En el método de Tomografía de Resistividad Eléctrica la adquisición consiste en la inyección de corriente en el subsuelo mediante un par de electrodos y la respuesta medida de la diferencia de potencial [voltaje] a través de otro par de electrodos llamados de potencial; la distribución del potencial eléctrico permite la reconstrucción de la resistividad eléctrica asociada a los diferentes materiales o litologías que conforman el subsuelo.</p>
							<hr style="margin-bottom: -20px;"/>
							<div align="center"><img align="center" src="img/iconos/electrico.png" alt="electico"></div>
							
							<p class=" text-center weight-400 letter-spacing-1 size-30">Profundidad:15 a 60 [m]<br>Fuente: Controlada <br>Modalidad Terrestre</p>
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-3 clearfix lightbox" data-img-big="4" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electrico1/Etapa2a.jpg">
									<img src="img/metodos/electrico1/Etapa2a.jpg" alt="...">
								</a>
								<a class="image-hover" href="img/metodos/electrico1/Picture1.png">
									<img src="img/metodos/electrico1/Picture1.png" alt="...">
								</a> 
								
								<a class="image-hover" href="img/metodos/electrico1/Picture3.png">
									<img src="img/metodos/electrico1/Picture3.png" alt="...">
								</a> 
								<a class="image-hover" href="img/metodos/electrico1/Picture2.png">
									<img src="img/metodos/electrico1/Picture2.png" alt="...">
								</a> <br> <br>
							</div>
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>

								<a class="image-hover" href="img/metodos/electrico1/Picture4.png">
									<img src="img/metodos/electrico1/Picture4.png" alt="...">
								</a> 
							</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electrico1/SeccionTRE5.jpg">
									<img src="img/metodos/electrico1/SeccionTRE5.jpg" alt="...">
								</a> <br>

							</div>
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>

								<a class="image-hover" href="img/metodos/electrico1/2.jpg" >
									<img src="img/metodos/electrico1/2.jpg" alt="...">
								</a>
							</div>
						...
						<div class="col-sm-6">
							<p class=" justify weight-400 letter-spacing-1 size-28">La técnica se reconoce como multielectrodica ya que es posible utilizar una variedad de configuraciones geométricas (arreglos) entre electrodos, las cuales mantienen dependencia con el objetivo de estudio. El procesamiento, inversión de datos e interpretación de los datos de TRE permiten obtener imágenes 2D o 3D de la distribución de resistividad eléctrica del subsuelo. <br> Este tipo de estudios requiere llevar a cabo un gran número de lecturas o mediciones para conseguir la resolución óptima lateral y horizontal que caracteriza a la técnica. Los dispositivos modernos permiten automatizar dicho proceso programando las lecturas y asegurando cobertura y buena calidad de los datos</p>
							<hr />							
						</div>
