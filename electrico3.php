...
<!--[if gt IE 9]><!-->	<html lang="es"> <!--<![endif]-->
	<head>
		<meta charset="utf-8" />
		<title>Geotem - Polarización Inducida Espectral</title>
		...
		<div id="wrapper">
						...
						<div id="rev_slider_18_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
							<ul>
								...
								<li data-index="rs-59" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="assets/images/demo/rs5/newspaper_bg1-100x50.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="Construcción" data-description="">
									<!-- MAIN IMAGE -->
									<img src="img/banner/bmetodos/poliesp.jpg"wid  alt=""  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
				...
				<div class="container">
					...
					<div class="row">
						<div style="margin-bottom: 30px;"class="heading-title heading-dotted text-center">
							<img class="img-responsive" src="img/metodos/electrico2/titulo15.png" alt="">
						</div>

						<div class="col-sm-6">
							<p class=" justify weight-400 letter-spacing-1 size-25">Desde hace décadas el método de la Polarización Inducida ha sido aplicado exitosamente en la exploración de yacimientos minerales. Los componentes metálicos de las menas dan origen a un efecto IP marcado, manifestándose en altas cargabilidades. En la actualidad el mismo efecto causado por elementos metálicos se está utilizando para caracterizar sitios contaminados por metales y monitorear trabajos de remediación. </p>
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electrico2/frecuencia.png">
									<img src="img/metodos/electrico2/frecuencia.png" alt="...">
								</a> <br>

							</div>
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>

								<a class="image-hover" href="img/metodos/electrico2/tiempo.png" >
									<img src="img/metodos/electrico2/tiempo.png" alt="...">
								</a>
							</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electrico2/Etapa2B.png">
									<img src="img/metodos/electrico2/Etapa2B.png" alt="...">
								</a> <br>

							</div>
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="4" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>

								<a class="image-hover" href="img/metodos/electrico2/1.png" >
									<img src="img/metodos/electrico2/1.png" alt="...">
								</a>
								<a class="image-hover" href="img/metodos/electrico2/2.png" >
									<img src="img/metodos/electrico2/2.png" alt="...">
								</a>
								<a class="image-hover" href="img/metodos/electrico2/3.png" >
									<img src="img/metodos/electrico2/3.png" alt="...">
								</a>
							</div>
						...
						<div class="col-sm-6">
							<p class=" justify weight-400 letter-spacing-1 size-28">A través de las amplitudes de la corriente inyectada y el voltaje medido así como el desfase entre corriente y voltaje se determinan el valor absoluto y la fase de la resistividad del subsuelo o bien la parte real y la imaginaria de la resistividad. <br> <br> La Polarización Inducida Espectral es un método geoeléctrico basado en la medición de la impedancia compleja del subsuelo.</p>
							<hr />							
						</div>
			...
			<section style="padding-top: 20px;">
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-6">
							<p class=" justify weight-400 letter-spacing-1 size-25">Las mediciones se realizan típicamente con corrientes alternas y con frecuencias en el rango desde un mHz a pocos  KHz para conocer la variación de la resistividad y de la fase con la frecuencia.  </p>
							<hr style="margin-bottom: -20px;"/>
						</div>
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electrico2/frecuencia.png">
									<img src="img/metodos/electrico2/Etapa3A.png" alt="...">
								</a> <br>
