...
<!--[if gt IE 9]><!-->	<html lang="es"> <!--<![endif]-->
	<head>
		<meta charset="utf-8" />
		<title>Geotem - Radio-Magnetolúrgico</title>
						...
						<div id="rev_slider_18_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
							<ul>
								...
								<li data-index="rs-59" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="assets/images/demo/rs5/newspaper_bg1-100x50.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="Construcción" data-description="">
									<!-- MAIN IMAGE -->
									<img src="img/banner/bmetodos/RMT.jpg"wid  alt=""  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										style="z-index: 6; zoom:0.7;"><a href="google.com"><img class="footer-logo" src="img/iconos/icongeotecnia.png"  width="50" height="auto"alt="geotermia" /></a>
									</div>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										style="z-index: 6; zoom:0.7;"><a href="google.com"><img class="footer-logo" src="img/iconos/iconmineria.png"  width="100" height="auto"alt="" /></a>
									</div>
									...
									<div class="tp-caption   rs-parallaxlevel-0" 
										...
										style="z-index: 6; zoom:0.7;"><a href="google.com"><img class="footer-logo" src="img/iconos/iconeduca.png"  width="100" height="auto"alt="" /></a>
									</div>

									<!-- LAYER NR. negro -->
									<div class="tp-caption   rs-parallaxlevel-0" 
										id="slide-20-layer-2" 
										data-x="['left','left','left','left']" data-hoffset="['1660','1580','1540','1540']" 
										data-y="['top','top','top','top']" data-voffset="['465','440','-40','-40']" 
										data-width="none"
										data-height="none"
										data-whitespace="nowrap"
										data-transform_idle="o:1;"
										...
										style="z-index: 6; zoom:0.47;"><a href="google.com"><img class="footer-logo" src="img/iconos/icoambiental.png"  width="100" height="auto"alt="" /></a>
									</div>
								</li>
				...
				<div class="container">
					...
					<div class="row">
						<div style="margin-bottom: 30px;"class="heading-title heading-dotted text-center">
							<img class="img-responsive" src="img/metodos/electromg3/titulo3.png" alt="">
						</div>

						<div class="col-sm-6">
							<p class=" justify weight-400 letter-spacing-1 size-28">El método Radio-Magnetotelurico (RMT) es una variante del método MT para la exploración superficial del subsuelo. Se encarga de medir las componentes del campo eléctrico y magnético con el fin de calcular la estructura resistiva de la Tierra; sin embargo a diferencia del MT el rango en el que opera es de alta frecuencia (100kHz – 1 MHz) de este modo es posible obtener una alta resolución en los primeros 250m de profundidad. Su fuente consiste en antenas radio transmisoras y debido a su arquitectura es un método bastante útil en la identificación y mapeo de estructuras como menas metálicas o afloramientos minerales.</p>
							<hr style="margin-bottom: -20px;"/>
							<div align="center"><img align="center" src="img/iconos/electromagnetico.png" alt="electro1"></div>
							
							<p class=" text-center weight-400 letter-spacing-1 size-30">Profundidad: 10 a 250m<br>Fuente: Natural <br>Modalidad Terrestre</p>
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electromg3/FaseRMT.jpg">
									<img src="img/metodos/electromg3/FaseRMT.jpg" alt="...">
								</a> <br>

							</div>
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>

								<a class="image-hover" href="img/metodos/electromg3/RMT3D.jpg" >
									<img src="img/metodos/electromg3/RMT3D.jpg" alt="...">
								</a>
							</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/electromg3/RadioMagneto.jpg">
									<img src="img/metodos/electromg3/RadioMagneto.jpg" alt="...">
								</a> <br>

							</div>
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>

								<a class="image-hover" href="img/metodos/electromg3/Profile_ RMTZ2.png" >
									<img src="img/metodos/electromg3/Profile_ RMTZ2.png" alt="...">
								</a>
							</div>
						...
						<div class="col-sm-6">
							<p class=" justify weight-400 letter-spacing-1 size-28">El equipo de registro consiste un digitalizador de señales de alta frecuencia auxiliado por sensores que permiten altas tasas de muestreo para registrar las variaciones de los campos eléctricos y magnéticos al incidir sobre la superficie del subsuelo.  Su operación es sencilla al requerir un mínimo de área para su ejecución.</p>
							<hr />							
						</div>
