...
<!--[if gt IE 9]><!-->	<html lang="es"> <!--<![endif]-->
	...
	<head>
		...
		<title>Geotem - Sismica de Reflexión</title>
						...
						<div id="rev_slider_18_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
							...
							<ul>
								...
								<li data-index="rs-59" data-transition="slideoverhorizontal" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="assets/images/demo/rs5/newspaper_bg1-100x50.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="Construcción" data-description="">
									...
									<img src="img/banner/bmetodos/SismReflex.JPG"  alt=""  data-bgposition="center bottom" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div style="margin-bottom: 30px;" class="heading-title heading-dotted text-center">
							...
							<img class="img-responsive" src="img/metodos/sismico5/titulo13.png" alt="">
						...
						<div class="col-sm-6">
							...
							<p class=" justify weight-400 letter-spacing-1 size-25">El método sísmico de refracción se desarrolló en la década de los 50´s y fue muy empleado en la industria petrolera antes de las innovaciones tecnológicas alcanzadas por los métodos de reflexión. <br> Sin embargo este método tiene grandes ventajas de aplicación, en sitios donde las discontinuidades o cambios de formación están muy próximos a la superficie.  La propiedad física a medir en los métodos sísmicos es la velocidad de propagación de las ondas que viajan a través del suelo. </p>

							<hr style="margin-bottom: -20px;"/>

							<div align="center"><img align="center" src="img/iconos/sismicos.png" alt="sismico"></div>

							

							<p class=" text-center weight-400 letter-spacing-1 size-30">Profundidad: 5 a 40 m <br>Fuente: Artificial <br>Modalidad Terrestre</p>
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/sismico5/SismReflex(1).jpg">

									<img src="img/metodos/sismico5/SismReflex(1).jpg" alt="...">
							...
							<div class="masonry-gallery columns-3 clearfix lightbox" data-img-big="" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/sismico5/Etapa2a.jpg" >

									<img src="img/metodos/sismico5/Etapa2a.jpg" alt="...">

								</a>

								<a class="image-hover" href="img/metodos/sismico5/Etapa2b.jpg" >

									<img src="img/metodos/sismico5/Etapa2b.jpg" alt="...">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox margin-top-30" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>

								<a class="image-hover" href="img/metodos/sismico5/Etapa3a.jpg">

									<img src="img/metodos/sismico5/Etapa3a.jpg" alt="...">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/sismico5/SismReflex(0).JPG" >

									<img src="img/metodos/sismico5/SismReflex(0).JPG" alt="...">
							...
							<div class="masonry-gallery columns-2 clearfix lightbox" data-img-big="1" data-plugin-options='{"delegate": "a", "gallery": {"enabled": true}}'>
								...
								<a class="image-hover" href="img/metodos/sismico5/Etapa3b.jpg">

									<img src="img/metodos/sismico5/Etapa3b.jpg" alt="...">
